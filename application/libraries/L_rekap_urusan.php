...
class L_rekap_urusan extends FPDF
{
    public $tablewidths;
    public $footerset;
    public $headerset;
    ...
    public function Header()
    {
        ...
        if (!isset($this->headerset[$this->page])) {
            ...
            $this->Cell(120);
            // Title
            $this->MultiCell(70, 3, 'Rencana Kerja Pemerintah Daerah (RKPD) Kota Payakumbuh Tahun ' .$this->data , 0, 'R');
            $this->Ln(3);}
            else{
              $this->SetY(10);
              $this->Cell(120);
            ...
            if ($this->PageNo()==1) {
              $this->SetY(20);
                // mencetak string
                $this->Cell(190, 5, 'Tabel V.2 ', 0, 1, 'C');
                $this->Cell(190, 5, "REKAPITULASI RENCANA PROGRAM DAN KEGIATAN PRIORITAS DAERAH TAHUN ANGARAN $this->data", 0, 1, 'C');
                $this->Cell(190, 5, "MENURUT URUSAN", 0, 1, 'C');
                $this->Cell(10, 5, '', 0, 1);
