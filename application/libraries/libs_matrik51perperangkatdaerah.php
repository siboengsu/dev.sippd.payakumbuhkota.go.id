...
class libs_matrik51perperangkatdaerah extends FPDF
{
    public $tablewidths;
    public $footerset;
    public $headerset;
    ...
    public function Header()
    {
        ...
        if (!isset($this->headerset[$this->page])) {
            ...
            $M = 20;
            $N = 13;
            $this->SetWidths = array($A,$B,$C,$E,$F,$G,$H,$I,$J,$K,$L,$M,$N);
            $x =$this->GetX();
            $y =$this->GetY();
            ...
            $this->MultiCell($H+$I, 3, '                  Indikator Kegiatan (outcome)/                    Indikator Sub Kegiatan (output)', 'L,R', 'C');
            $this->Ln(0);
