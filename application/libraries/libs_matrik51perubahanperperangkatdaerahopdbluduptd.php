...
class libs_matrik51perubahanperperangkatdaerahopdbluduptd extends FPDF
{
    public $tablewidths;
    public $footerset;
    public $headerset;
    ...
    public function Header()
    {
        ...
        if (!isset($this->headerset[$this->page])) {
            ...
            $this->Cell(223);
            // Title
            $this->MultiCell(64, 4, 'Perubahan Rencana Kerja Perubahan Tahun ' .$this->data , 0, 'R');
            $this->Ln(2);
            // Line break
            $this->Ln(4);
            if ($this->PageNo()==1) {
...
//                $this->Cell(10, 2, '', 0, 1);
				...
				$this->Cell(285, 2, "$this->SKPD ", 0, 1, 'L');
                $tinggi = 37;
            } else {
                $tinggi = 23;
            }
            ...
            //line 2
            $this->Cell($A,4,'',0,0);
            $this->MultiCell($B,3.5,'Urusan Pemerintah Daerah/Program/Kegiatan/Sub Kegiatan',0,'C');
            $this->SetXY($x +$A+$B, $tinggi);
            $this->MultiCell($C,4,'Prioritas/RG','L,R','C');
