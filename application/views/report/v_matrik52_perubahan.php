...
<div class="row">
	<div class="col-md-12">
		<div class="page-header">
			<h1>Matrik 5.2 Perubahan Menurut Urusan</h1>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="matrik52_cetak_perubahan">
...
$(function() {
	...
	$('#matrik52_cetak_perubahan').submit(function(e) {
		e.preventDefault();
			var nomor = $('#f-nomor').val();
			var id = $('#reportformat').val();
		if (id=="1") {

		$.post('Report_matrik/c_rekap_urusan_perubahan/'+nomor, $(this).serialize(), function(res, status, xhr) {
			if(contype(xhr) == 'json') {
				respond(res);
			} else {
				window.open("Report_matrik/c_rekap_urusan_perubahan/"+nomor, "_blank");
			}
		});
		} else if (id=="2") {
