...
$(function() {
	...
	$(document).on('submit', blockReport + '.renja-matrik-cetak-opd-blud-uptd', function(e) {
		...
		e.preventDefault();
		$.post('/c_matrik51perubahanperperangkatdaerahopduptdblud/contr_matrik51perperangkatdaerahopdbluduptd/'+unitkey+"/"+nomor, $(blockReport + '.renja-matrik-cetak-opd-blud-uptd').serializeArray(), function(res, status, xhr) {
			if(contype(xhr) == 'json') {
				...
				console.log("sukses");
					...
					console.log(unitkey);
				window.open("c_matrik51perubahanperperangkatdaerahopduptdblud/contr_matrik51perperangkatdaerahopdbluduptd/"+unitkey+"/"+nomor, "_blank");
			}
		});
