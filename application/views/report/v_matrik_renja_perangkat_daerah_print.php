...
<div class="f14 w100 landscape" >
	<p class="text-center judul" style="font-size:12px; font-weight:bold;">
		<br>
		PLAFON ANGGARAN MATRIK RENJA PERANGKAT DAERAH TAHUN <?php echo $NMTAHUN; ?> <br><br><br>
...
<div style="font-size:12px; font-weight:bold;">Organisasi / PD :<?php echo $aa ?>  </div>
...
Daerah dan </th>
		...
		<th rowspan="3" class="normal">Pagu Indikatif</th>
		<th rowspan="3" class="normal">Prakiraan Maju</th>
	...
	<tr>
		...
		<td class="va-top"><?php echo $data->PRIODAERAH ?></td>
		<td class="va-top"><?php echo $data->SASARAN ?></td>
		<td class="va-top"><?php echo $data->LOKASI ?></td>
		...
		<td class="va-top text-right"><?php echo $NM ?></td>
		<td class="va-top"><?php echo $NMKEG ?></td>
		<td style="display:none">  <?php echo number_format($detailpagu, 0, ',', '.') ?></td>
