...
<div class="row">
	<div class="col-md-12">
		<div class="page-header">
			<h1>Cetak Laporan Matrik 5.1 Per Perangkat Daerah(UPTD + BLUD)</h1>
		</div>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal renja-matrik-cetak-opd-blud-uptd" id="renja-matrik-cetak-opd-blud-uptd" name="renja-matrik-cetak-opd-blud-uptd">
						...
						<div class="col-sm-8">
							...
							<div class="input-group">
								<span class="input-group-btn">
									<button type="button" class="btn btn-default btn-lookup-unit-opd-blud-uptd" data-setid="#f-unitkey" data-setkd="#v-kdunit" data-setnm="#v-nmunit"><i class="fa fa-folder-open"></i></button>
								</span>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<div class="input-group flatpickr">
								<input type="text" name="f-tanggal" id="f-tanggal" value="<?php echo date("Y-m-d"); ?>" class="form-control text-center" data-input>
...
$(function() {
	...
	$(document).off('submit', blockReport + '.renja-matrik-cetak-opd-blud-uptd');
	$(document).on('submit', blockReport + '.renja-matrik-cetak-opd-blud-uptd', function(e) {
		var nomor = $('#f-nomor').val();
		var unitkey = $('#f-unitkey').val();
		var periode = $('#f-tanggal').val();
		e.preventDefault();
		$.post('/c_matrik51perperangkatdaerahopduptdblud/contr_matrik51perperangkatdaerahopdbluduptd/'+unitkey+"/"+periode+"/"+nomor, $(blockReport + '.renja-matrik-cetak-opd-blud-uptd').serializeArray(), function(res, status, xhr) {
			if(contype(xhr) == 'json') {
				...
				console.log("sukses");
					...
					console.log(unitkey);
				window.open("c_matrik51perperangkatdaerahopduptdblud/contr_matrik51perperangkatdaerahopdbluduptd/"+unitkey+"/"+periode+"/"+nomor, "_blank");
			}
		});
