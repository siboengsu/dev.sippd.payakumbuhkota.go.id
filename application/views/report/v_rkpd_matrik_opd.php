	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="renja-matrik-opd" name="renja-matrik-opd">
...
$(function() {
	...
	$('#renja-matrik-opd').submit(function(e) {
		e.preventDefault();
		var id = $('#f-unitkey').val();
		var idprint = $('#reportformat').val();
		if (idprint=="1") {
				$.post('report/cetak_matrik_renja_opd/'+id, $(this).serialize(), function(res, status, xhr) {
					if(contype(xhr) == 'json') {
						respond(res);
					} else {
						window.open("report/cetak_matrik_renja_opd/print/"+id, "_blank");
					}
					});
							} else if (idprint =="2") {
