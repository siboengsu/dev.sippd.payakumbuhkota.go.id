...
<div class="f14 w100" >
	<p class="text-center bold" style="font-size:12px;">
		 TABEL 4.1 <br>
		PLAFON ANGGARAN SEMENTARA BERDASARKAN URUSAN PEMERINTAHAN TAHUN <?php echo $NMTAHUN; ?> <br>
				...
				<tr>
					<td class="text-center">Payakumbuh, <?php echo tanggal_indo($TANGGAL); ?>
						...
						<br>Kepala Bappeda
							...
							<br>
							<br>
							<br><u>Drs. IFON SATRIA CHAN, M. Si</u>
							<br>NIP. 19751005 199501 1 001                
					</td>
				</tr>
				<?php
